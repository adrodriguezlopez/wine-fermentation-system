...
def test_value_validation_service_validates_positive_sugar_values(
    value_validation_service,
):
    # Act
...
def test_value_validation_service_validates_negative_sugar_values(
    value_validation_service,
):
    # Act
...
def test_value_validation_service_validate_sample_type_not_supported(
    value_validation_service,
):
    # Act
...
def test_value_validation_service_validates_numeric_value_within_range(
    value_validation_service,
):
    # Act
    result = value_validation_service.validate_numeric_value(
        25.0, min_value=20.0, max_value=30.0
    )
...
def test_value_validation_service_validates_numeric_value_below_min(
    value_validation_service,
):
    # Act
    result = value_validation_service.validate_numeric_value(
        15.0, min_value=20.0, max_value=30.0
    )
...
def test_value_validation_service_validates_numeric_value_above_max(
    value_validation_service,
):
    # Act
    result = value_validation_service.validate_numeric_value(
        35.0, min_value=20.0, max_value=30.0
    )
...
def test_value_validation_service_validates_numeric_value_non_numeric(
    value_validation_service,
):
    # Act
    result = value_validation_service.validate_numeric_value(
        "not_a_number", min_value=20.0, max_value=30.0
    )
