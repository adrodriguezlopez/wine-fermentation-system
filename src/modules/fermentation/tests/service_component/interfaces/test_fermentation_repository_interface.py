...
def test_fermentation_repository_interface_methods():
    """
    ...
    """
    try:
        from service_component.interfaces.fermentation_repository_interface import IFermentationRepository
    except ImportError:
    ...
    interface_methods = {
        name for name, value in IFermentationRepository.__dict__.items()
