...
const fermentation2 = { ...baseFermentation, id: 2, vessel_code: 'VAT-02' }
...
export const fermentationHandlers = [
  ...
  // GET /api/fermentation/fermentations/:id/samples/latest
  ...
  // GET /api/analysis/analyses/fermentation/:id
