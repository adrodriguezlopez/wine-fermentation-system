...
def test_sample_repository_interface_methods():
    """
    ...
    """
    try:
        from service_component.interfaces.sample_repository_interface import ISampleRepository
    except ImportError:
    ...
    interface_methods = {
        name for name, value in ISampleRepository.__dict__.items()
