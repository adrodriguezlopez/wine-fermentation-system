...
def register_error_handlers(app) -> None:
    ...
    async def fermentation_not_found_handler(
        request: Request, exc: FermentationNotFound
    ) -> JSONResponse:
    ...
    async def sample_not_found_handler(
        request: Request, exc: SampleNotFound
    ) -> JSONResponse:
    ...
    async def invalid_fermentation_state_handler(
        request: Request, exc: InvalidFermentationState
    ) -> JSONResponse:
    ...
    async def fermentation_already_completed_handler(
        request: Request, exc: FermentationAlreadyCompleted
    ) -> JSONResponse:
    ...
    async def invalid_sample_date_handler(
        request: Request, exc: InvalidSampleDate
    ) -> JSONResponse:
    ...
    async def invalid_sample_value_handler(
        request: Request, exc: InvalidSampleValue
    ) -> JSONResponse:
