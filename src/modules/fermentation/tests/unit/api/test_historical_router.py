...
class TestListHistoricalFermentations:
    ...
    @pytest.mark.asyncio
    async def test_list_returns_paginated_response_with_filters(
        self, client, mock_fermentation_service, mock_fermentation
    ):
        ...
        call_kwargs = (
            mock_fermentation_service.get_fermentations_by_winery.call_args.kwargs
        )
    ...
    @pytest.mark.asyncio
    async def test_list_with_minimal_parameters(
        self, client, mock_fermentation_service, mock_fermentation
    ):
    ...
    async def test_list_handles_service_errors(self, client, mock_fermentation_service):
        ...
        # Arrange
        mock_fermentation_service.get_fermentations_by_winery.side_effect = Exception(
            "Database error"
        )
        ...
        assert (
            "Failed to retrieve historical fermentations" in response.json()["detail"]
        )
...
class TestGetHistoricalFermentation:
    ...
    @pytest.mark.asyncio
    async def test_get_returns_fermentation_when_found(
        self, client, mock_fermentation_service, mock_fermentation
    ):
        ...
        mock_fermentation_service.get_fermentation.assert_called_once_with(
            fermentation_id=1, winery_id=1
        )

    @pytest.mark.asyncio
    async def test_get_returns_404_when_not_found(
        self, client, mock_fermentation_service
    ):
    ...
    async def test_get_handles_service_errors(self, client, mock_fermentation_service):
        """Test that service errors are handled gracefully."""
        # Arrange
        mock_fermentation_service.get_fermentation.side_effect = Exception(
            "Database error"
        )
...
class TestGetFermentationSamples:
    ...
    @pytest.mark.asyncio
    async def test_get_samples_returns_list(
        self,
        client,
    ...
    async def test_get_samples_returns_404_when_fermentation_not_found(
        self, client, mock_fermentation_service, mock_sample_service
    ):
        """Test that 404 is returned when fermentation doesn't exist."""
        # Arrange
        mock_fermentation_service.get_fermentation.return_value = None
    ...
    @pytest.mark.asyncio
    async def test_get_samples_handles_service_errors(
        self, client, mock_fermentation_service, mock_sample_service
    ):
        """Test that service errors are handled gracefully."""
        # Arrange
...
class TestExtractPatterns:
    ...
    async def test_extract_patterns_returns_aggregated_metrics(
        self, client, mock_pattern_service
    ):
    ...
    @pytest.mark.asyncio
    async def test_extract_patterns_with_minimal_filters(
        self, client, mock_pattern_service
    ):
    ...
    @pytest.mark.asyncio
    async def test_extract_patterns_handles_service_errors(
        self, client, mock_pattern_service
    ):
        """Test that service errors are handled gracefully."""
        # Arrange
...
class TestGetDashboardStatistics:
    ...
    @pytest.mark.asyncio
    async def test_get_statistics_returns_dashboard_metrics(
        self, client, mock_pattern_service
    ):
    ...
    @pytest.mark.asyncio
    async def test_get_statistics_handles_service_errors(
        self, client, mock_pattern_service
    ):
        """Test that service errors are handled gracefully."""
        # Arrange
...
class TestListImportJobs:
    ...
    async def test_list_jobs_accepts_pagination_params(self, client):
        ...
        # Act
        response = client.get(
            "/api/v1/fermentation/historical/import", params={"limit": 20, "offset": 10}
        )
