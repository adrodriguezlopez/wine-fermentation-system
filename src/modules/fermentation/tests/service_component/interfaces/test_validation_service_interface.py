...
def test_validation_service_interface_methods() -> None:
    """
    ...
    """
    try:
        from service_component.interfaces.validation_service_interface import (
            IValidationService,
        )
    except ImportError:
    ...
    interface_methods = {
        name
        for name, value in IValidationService.__dict__.items()
