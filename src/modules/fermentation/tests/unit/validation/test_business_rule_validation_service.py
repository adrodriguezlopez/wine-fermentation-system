...
@pytest.fixture
def business_validation_service(mock_sample_repository):
    return BusinessRuleValidationService(sample_repository=mock_sample_repository)
...
@pytest.mark.asyncio
async def test_business_rule_validation_service_handles_missing_repository():
    # Arrange
    service = BusinessRuleValidationService(sample_repository=None)  # No repository
...
async def test_business_rule_validation_service_validates_temperature_within_range(business_validation_service):
    # Arrange
    business_validation_service.sample_repository.get_fermentation_temperature_range.return_value = (18.0, 30.0)  # Acceptable range
...
async def test_business_rule_validation_service_handles_no_temperature_range(business_validation_service):
    # Arrange
    business_validation_service.sample_repository.get_fermentation_temperature_range.return_value = None  # No range defined
