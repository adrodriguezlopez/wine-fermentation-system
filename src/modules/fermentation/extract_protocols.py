...
STEP_PATTERNS = {
    ...
    "INITIALIZATION": [
        ...
        r"pitch",
        r"yeast",
        r"starter",  # YEAST_INOCULATION
        r"cold.*soak",
        r"pre-soak",  # COLD_SOAK
    ],
    # MONITORING steps
    "MONITORING": [
        r"temperatur",
        r"temp\b",
        r"cool",
        r"ferment.*temp",  # TEMPERATURE_CHECK
        r"h2s",
        r"hydrogen sulfide",
        r"smell",
        r"rotten egg",  # H2S_CHECK
        r"brix",
        r"sugar",
        r"density",
        r"sg\b",
        r"gravity",  # BRIX_READING
    ],
    # ADDITIONS steps
    "ADDITIONS": [
        r"dap\b",
        r"diammon",
        r"nutrient.*addition",  # DAP_ADDITION
        r"nutrient",
        r"yeast nutrient",
        r"feeding",  # NUTRIENT_ADDITION
        r"so2\b",
        r"sulfite",
        r"sulfur",  # SO2_ADDITION
        r"mlf\b",
        r"malo.*lactic",
        r"malolactic",  # MLF_INOCULATION
    ],
    # CAP_MANAGEMENT steps
    "CAP_MANAGEMENT": [
        r"punch.*down",
        r"punchdown",
        r"cap\s+management",  # PUNCH_DOWN
        r"pump.*over",
        r"pumpover",
        r"recircul",  # PUMP_OVER
    ],
    ...
    "QUALITY_CHECK": [
        r"inspect",
        r"observe",
        r"check.*appearance",  # VISUAL_INSPECTION
        r"tast",
        r"flavor",  # CATA_TASTING
    ],
}
