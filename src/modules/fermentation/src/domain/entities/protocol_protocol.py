...
class FermentationProtocol(BaseEntity):
    ...
    varietal_code: Mapped[str] = mapped_column(
        String(10), nullable=False
    )  # "PN", "CH", "CS"
    varietal_name: Mapped[str] = mapped_column(
        String(100), nullable=False
    )  # "Pinot Noir"
    color: Mapped[str] = mapped_column(
        String(10), nullable=False, default="RED"
    )  # RED, WHITE, ROSÉ
    ...
    state: Mapped[str] = mapped_column(
        String(20), default=ProtocolState.FINAL, nullable=False
    )
