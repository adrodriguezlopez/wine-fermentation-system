...
def test_sample_service_interface_methods():
    """
    ...
    """
    try:
        from service_component.interfaces.sample_service_interface import ISampleService
    except ImportError:
    ...
    interface_methods = {
        name for name, value in ISampleService.__dict__.items()
