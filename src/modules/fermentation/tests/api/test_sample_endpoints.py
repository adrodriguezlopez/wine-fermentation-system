...
class TestPostSample:
    ...
    def test_create_sample_fermentation_not_found(self, client):
        ...
        response = client.post("/api/v1/fermentations/99999/samples", json=sample_data)
    ...
    def test_create_sample_without_authentication(self, unauthenticated_client):
        ...
        response = unauthenticated_client.post(
            "/api/v1/fermentations/1/samples", json=sample_data
        )
...
class TestGetSample:
    ...
    def test_get_sample_not_found(self, client, mock_user_context):
        ...
        response = client.get(f"/api/v1/fermentations/{fermentation_id}/samples/99999")
...
class TestGetLatestSample:
    ...
    def test_get_latest_sample_success(self, client, mock_user_context):
        ...
        # Get latest sample
        response = client.get(f"/api/v1/fermentations/{fermentation_id}/samples/latest")
...
class TestGetSamplesInTimerange:
    ...
    def test_get_samples_in_timerange_without_authentication(
...
class TestValidateSample:
    ...
    def test_validate_sample_without_authentication(self, unauthenticated_client):
        ...
        response = unauthenticated_client.post(
            "/api/v1/samples/validate", params={"fermentation_id": 1}, json=sample_data
        )
...
class TestDeleteSample:
    ...
    def test_delete_sample_success(self, client):
        ...
        response = client.delete(
            f"/api/v1/samples/{sample_id}", params={"fermentation_id": fermentation_id}
        )
    ...
    def test_delete_sample_not_found(self, client):
        ...
        response = client.delete(
            "/api/v1/samples/999", params={"fermentation_id": fermentation_id}
        )
    ...
    def test_delete_sample_without_authentication(self, unauthenticated_client):
        ...
        response = unauthenticated_client.delete(
            "/api/v1/samples/1", params={"fermentation_id": 1}
        )
