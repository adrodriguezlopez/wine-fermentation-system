...
class TestPostFermentations:
    ...
    def test_create_fermentation_missing_required_fields(self, client):
        ...
        request_data = {"vintage_year": 2024, "vessel_code": "TANK-01"}
    ...
    def test_create_fermentation_multi_tenancy_isolation(
        self, client, mock_user_context
    ):
        """
    ...
    def test_create_fermentation_without_authentication(self, unauthenticated_client):
        ...
        response = unauthenticated_client.post(
            "/api/v1/fermentations", json=request_data
        )
    ...
    @pytest.mark.skip(
        reason="TDD: Pending require_winemaker implementation in endpoint"
    )
    def test_create_fermentation_unauthorized_role(self, test_db_session):
        ...
        viewer_context = UserContext(
            user_id=99, winery_id=1, email="viewer@winery.com", role=UserRole.VIEWER
        )
...
class TestGetFermentationEndpoint:
    ...
    def test_get_fermentation_unauthorized_role(self, override_db_session):
        ...
        winemaker_app = create_test_app(
            user_override=winemaker_context, db_override=override_db_session
        )
        winemaker_client = TestClient(winemaker_app)

        create_response = winemaker_client.post(
            "/api/v1/fermentations",
            json={
                "vintage_year": 2024,
                "yeast_strain": "EC-1118",
        ...
        viewer_context = UserContext(
            user_id=2, winery_id=1, email="viewer@winery.com", role=UserRole.VIEWER
        )
        app = create_test_app(
            user_override=viewer_context, db_override=override_db_session
        )
        client = TestClient(app)
...
class TestGetFermentationsListEndpoint:
    ...
    def test_list_fermentations_multi_tenancy(self, override_db_session):
        ...
        winery1_context = UserContext(
            user_id=1, winery_id=1, email="user1@winery1.com", role=UserRole.WINEMAKER
        )
        app1 = create_test_app(
            user_override=winery1_context, db_override=override_db_session
        )
        ...
        winery2_context = UserContext(
            user_id=2, winery_id=2, email="user2@winery2.com", role=UserRole.WINEMAKER
        )
        app2 = create_test_app(
            user_override=winery2_context, db_override=override_db_session
        )
...
class TestPatchFermentationEndpoint:
    ...
    def test_update_fermentation_success(
        self, client, mock_user_context, test_db_session
    ):
        """
        ...
        update_data = {"yeast_strain": "D47", "vessel_code": "TANK-02"}
        response = client.patch(
            f"/api/v1/fermentations/{fermentation_id}", json=update_data
        )
...
class TestPatchStatusEndpoint:
    ...
    def test_update_status_not_found(self, client):
        ...
        response = client.patch(
            "/api/v1/fermentations/999999/status", json={"status": "COMPLETED"}
        )
    ...
    def test_update_status_without_authentication(self, unauthenticated_client):
        ...
        response = unauthenticated_client.patch(
            "/api/v1/fermentations/1/status", json={"status": "COMPLETED"}
        )
...
class TestPatchCompleteEndpoint:
    ...
    def test_complete_fermentation_minimal(self, client):
        ...
        response = client.patch(
            f"/api/v1/fermentations/{fermentation_id}/complete",
            json={"final_sugar_brix": 2.5, "final_mass_kg": 95.0},
        )
    ...
    def test_complete_fermentation_invalid_metrics(self, client):
        ...
        response = client.patch(
            f"/api/v1/fermentations/{fermentation_id}/complete",
            json={"final_sugar_brix": -1.0, "final_mass_kg": 95.0},
        )
    ...
    def test_update_fermentation_without_authentication(self, unauthenticated_client):
        ...
        update_data = {"yeast_strain": "D47"}
        response = unauthenticated_client.patch(
            "/api/v1/fermentations/1", json=update_data
        )
    ...
    def test_update_fermentation_requires_winemaker_role(
        self, client, mock_user_context
    ):
        """
...
class TestValidateFermentationEndpoint:
    ...
    def test_validate_fermentation_without_authentication(self, unauthenticated_client):
        ...
        response = unauthenticated_client.post(
            "/api/v1/fermentations/validate", json=data
        )
        assert response.status_code in [401, 403]
...
class TestGetFermentationTimeline:
    ...
    def test_get_timeline_success(self, client):
        ...
        fermentation_response = client.post(
            "/api/v1/fermentations", json=fermentation_data
        )
        ...
        samples = [
            ...
            },
            {
                ...
                "value": 15.0,
                "units": "°Brix",
                "recorded_at": "2024-11-04T10:00:00",
            },
        ]
        for sample_data in samples:
            client.post(
                f"/api/v1/fermentations/{fermentation_id}/samples", json=sample_data
            )
    ...
    def test_get_statistics_success(self, client):
        ...
        samples = [
            ...
            },
            {
                ...
                "value": 20.0,
                "units": "°C",
                "recorded_at": "2024-11-05T10:00:00",
            },
        ]
        for sample_data in samples:
            client.post(
