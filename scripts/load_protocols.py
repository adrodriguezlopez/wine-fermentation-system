...
# Mapping of JSON step types to StepType enum
STEP_TYPE_MAPPING: Dict[str, StepType] = {
    "YEAST_INOCULATION": StepType.YEAST_INOCULATION,
    "TEMPERATURE_CHECK": StepType.TEMPERATURE_CHECK,
    "H2S_CHECK": StepType.H2S_CHECK,
    "BRIX_READING": StepType.BRIX_READING,
    "DAP_ADDITION": StepType.DAP_ADDITION,
    "PUNCH_DOWN": StepType.PUNCH_DOWN,
    "NUTRIENT_ADDITION": StepType.NUTRIENT_ADDITION,
    "RACK_TRANSFER": StepType.RACK_TRANSFER,
    "COLD_SOAK": StepType.COLD_SOAK,
    "MLF_INOCULATION": StepType.MLF_INOCULATION,
    "SULFITE_ADDITION": StepType.SULFITE_ADDITION,
    "TEMPERATURE_ADJUSTMENT": StepType.TEMPERATURE_ADJUSTMENT,
    "SETTLING": StepType.SETTLING,
    "FILTRATION": StepType.FILTRATION,
    "PH_CHECK": StepType.PH_CHECK,
    "FLAVOR_PROFILE_ASSESSMENT": StepType.FLAVOR_PROFILE_ASSESSMENT,
    "FINAL_ADJUSTMENT": StepType.FINAL_ADJUSTMENT,
}
